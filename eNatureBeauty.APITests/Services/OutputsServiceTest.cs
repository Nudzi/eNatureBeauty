...
namespace eNatureBeauty.Test.Services
{
    public class OutputsServiceTest
    {
        ...
        [Fact]
        public void FilterByOrderId_ReturnObject()
        {
        ...
        [Fact]
        public void FilterByReceiveNumber_ReturnObject()
        {
            _context.Outputs.Add(new Outputs
            {
                Id = 3,
        ...
        [Fact]
        public void FilterByReceiveNumberAndOrderId_ReturnEmpty()
        {
            _context.Outputs.Add(new Outputs
            {
                Id = 6,
        ...
        [Fact]
        public void FilterByReceiveNumberAndOrderId_ReturnObject()
        {
            _context.Outputs.Add(new Outputs
            {
                Id = 8,
